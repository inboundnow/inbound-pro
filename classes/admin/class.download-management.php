...
class Inbound_Pro_Downloads {
	...
	*/	
	public static function run_installation() {
		...
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, self::$download['fileserver']);
		...
		<div class="wrap">
			<div id="grid" class="container-fluid">
				...
				foreach (self::$downloads as $download) {	
					...
					?>
					<div class="row col-md-3 col-xs-3 download-item " data-plugins='<?php echo json_encode( $download['plugins'] );	?>' data-meta='<?php echo json_encode( $download['status'] ); ?>'  >
