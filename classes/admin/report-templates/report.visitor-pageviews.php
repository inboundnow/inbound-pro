...
if (!class_exists('Inbound_Visitor_Impressions_Report')) {
    ...
    class Inbound_Visitor_Impressions_Report extends Inbound_Reporting_Templates {
            ...
            <table class="visits-by-lead">
                ...
                <tr>
                    ...
                    <th scope="col" class="manage-column column-modified sort-lead-report-by" sort-by="report-date-header" sort-order="1">
                        <span><?php _e('Datetime Visited' , 'inbound-pro'); ?><i class="fa fa-caret-down lead-report-sort-indicater" aria-hidden="true" style="padding-left:4px"></i></span>
                    </th>
                ...
                <tr>
                    ...
                    <th scope="col" class="manage-column column-modified sort-lead-report-by" sort-by="report-date-header">
                        <span><?php _e('Datetime Visited' , 'inbound-pro'); ?><i class="fa fa-caret-down lead-report-sort-indicater" aria-hidden="true" style="padding-left:4px"></i></span>
                    </th>
                    <th scope="col" class="manage-column column-modified ">
                        <span><?php _e('Origin' , 'inbound-pro'); ?></span>
    ...
    new Inbound_Visitor_Impressions_Report;
