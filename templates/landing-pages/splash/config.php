...
<p>This is the final sentence or paragraph reassuring the visitor of the benefits of filling out the form and how their data will be safe.</p>'
	...
	array(
		...
		'type' => "media",
		'default' => $path . "images/background.jpg",
		'selector' => ".landing .topslot",
	),
	array(
	...
	array(
		...
		'description' => "Subheadline text or html or shortcodes here",
		'id' => "subheadline",
		'type' => "textarea",
		'default' => "Convince and convert visitors",
		'selector' => ".brief p",
	),
