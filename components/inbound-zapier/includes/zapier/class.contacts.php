...
class Zapier_Contacts extends Zapier_BaseClient{
	//Client for Zapier Contacts API
    ...
    **/
    public function create_contact($params){
    	...
    	try{
    		...
    		throw new Zapier_Exception('Unable to create contact: ' . $e);
    	}
    }
    ...
    **/
    public function update_contact($vid, $params){
    	...
    	try{
    		...
    		throw new Zapier_Exception('Unable to update contact: ' . $e);
    	}
    }
    ...
    **/
    public function delete_contact($vid){
    	...
    	try{
    		...
    		throw new Zapier_Exception('Unable to delete contact: ' . $e);
    	}
    }
    ...
    **/
    public function get_all_contacts($params){
    	...
    	try{
    		...
    		throw new Zapier_Exception('Unable to get contacts: '.$e);
    	}
    }
    ...
    **/
    public function get_contact_by_id($vid){
    	...
    	try{
    		...
    		throw new Zapier_Exception('Unable to get contact: '.$e);
    	}
    }
    ...
    **/
    public function search_contacts($params){
    	...
    	try{
    		...
    		throw new Zapier_Exception("Unable to search contacts: ".$e);
