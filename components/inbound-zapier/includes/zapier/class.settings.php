...
class Zapier_Settings extends Zapier_BaseClient {
    //Client for Zapier Settings API.
    ...
    **/
    public function get_settings() {
        ...
        try {
            ...
            throw new Zapier_Exception('Unable to retrieve settings: ' . $e);
        }
    }
    ...
    **/
    public function get_setting($settingName) {
        ...
        try {
            ...
            throw new Zapier_Exception('Unable to retrieve setting: ' . $e);
        }
    }
    ...
    **/
    public function update_setting($settingName, $value) {
        ...
        try {
            ...
            throw new Zapier_Exception('Unable to update setting: ' . $e);
        }
    ...
    **/
    public function delete_setting($settingName) {
        ...
        try {
            ...
            throw new Zapier_Exception('Unable to delete setting: ' . $e);
        }
    }
}