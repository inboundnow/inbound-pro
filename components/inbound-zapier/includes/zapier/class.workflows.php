...
class Zapier_Workflows extends Zapier_BaseClient{
	...
	**/
	public function get_all_workflows(){
		...
		try{
			...
			throw new Zapier_Exception('Unable to get workflows: '.$e);
		}
	}
	...
	**/
	public function get_workflow_by_ID($id){
		...
		try{
			...
			throw new Zapier_Exception('Unable to get workflow: '.$e);
		}
	}
	...
	**/
	public function get_current_enrollments($vid){
		...
		try{
			...
			throw new Zapier_Exception('Unable get enrollments for contact: '.$e);
		}
	}
	...
	**/
	public function get_log_events($wfID, $vid, $params){
		...
		try{
			...
			throw new Zapier_Exception('Unable get log events for contact: '.$e);
		}
	}	
	...
	**/
	public function get_upcoming_events($wfID, $vid, $params){
		...
		try{
			...
			throw new Zapier_Exception('Unable get upcoming events for contact: '.$e);
		}
	}
