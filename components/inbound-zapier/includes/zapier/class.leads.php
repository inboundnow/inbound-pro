...
class Zapier_Leads extends Zapier_BaseClient {
    //Client for Zapier Leads API.
    ...
    **/
    public function get_leads($params) {
        ...
        try {
            ...
            throw new Zapier_Exception('Unable to retrieve list: ' . $e);
        }
    ...
    **/
    public function get_lead($leadGuid) {
        ...
        try {
            ...
            throw new Zapier_Exception('Unable to retrieve lead: ' . $e);
        }
    }
    ...
    **/
    public function update_lead($leadGuid, $updateData) {
        ...
        try {
            ...
            throw new Zapier_Exception('Unable to update lead: ' . $e);
        }
    }
    ...
    **/
    public function close_lead($leadGuid, $closeDate) {
        ...
        try {
            ...
            throw new Zapier_Exception('Unable to close lead: ' . $e);
        }
    }

    /**
    * Adds a single lead to Zapier via the Lead Tracking API
    *
    * @param formURL: String value fo the form URL to POST to
    * @param postFields: Array of fields and values to post to Zapier
    *
    * @returns Response body from HTTP PUT request
    *
    * @throws Zapier_Exception
    **/
    public function add_lead($formURL, $postFields) {
        ...
        try {
            ...
            throw new Zapier_Exception('Unable to add lead: ' . $e);
        }
    }
    ...
    **/
    public function get_webhooks() {
        ...
        try {
            ...
            throw new Zapier_Exception('Unable to retrieve webhooks: ' . $e);
        }
    }
    ...
    **/
    public function register_webhook($callbackURL) {
        ...
        if ($this->isBlank($callbackURL)) {
            throw new Zapier_Exception('callbackURL is required');
        }
        ...
        try {
            ...
            throw new Zapier_Exception('Unable to register webhook: ' . $e);
        }
    }
