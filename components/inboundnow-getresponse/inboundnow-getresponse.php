...
class InboundNow_GetResponse {
	...
	static function inboundnow_getresponse_extension_setup() {
		...
		if ( class_exists( 'INBOUNDNOW_EXTEND' ) )
			$license = new INBOUNDNOW_EXTEND( INBOUNDNOW_GETRESPONSE_FILE , INBOUNDNOW_GETRESPONSE_LABEL , INBOUNDNOW_GETRESPONSE_SLUG , INBOUNDNOW_GETRESPONSE_CURRENT_VERSION  , INBOUNDNOW_GETRESPONSE_REMOTE_ITEM_NAME ) ;
