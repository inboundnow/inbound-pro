...
function inboundnow_hubspot_extension_setup()
{
	...
	if ( class_exists( 'Inbound_License' ) )   
		$license = new Inbound_License( INBOUNDNOW_HUBSPOT_FILE , INBOUNDNOW_HUBSPOT_LABEL , INBOUNDNOW_HUBSPOT_SLUG , INBOUNDNOW_HUBSPOT_CURRENT_VERSION  , INBOUNDNOW_HUBSPOT_REMOTE_ITEM_NAME ) ;
