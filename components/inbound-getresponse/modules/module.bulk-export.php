...
add_action('admin_footer-edit.php', 'inboundnow_getresponse_bulk_actions_add_options');
function inboundnow_getresponse_bulk_actions_add_options() 
{
...
add_action('load-edit.php', 'wpleads_bulk_action_getresponse');
function wpleads_bulk_action_getresponse() {
		...
		switch($action) {
			case 'export-getresponse':
				...
				foreach( $post_ids as $post_id ) {		
					...
					inboundnow_getresponse_add_subscriber( $lead_data  , $target_list);
