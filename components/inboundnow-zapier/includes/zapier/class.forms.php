...
class Zapier_Forms extends Zapier_Baseclient{
	...
	*		guid: The unique ID for the form (found in Forms tool in your Zapier account)
	*		form_fields: A key-value array of the form fields submitted by the end user. 
	*					 The key should match the key for the contact property in Zapier. 
	...
	**/
	public function submit_form($portalId, $guid, $form_fields, $hs_context){
		$url_base = 'https://forms.zapier.com/uploads/form/v2/'.$portalId.'/'.$guid;
