...
class Zapier_Blog extends Zapier_BaseClient {
    //Client for Zapier Blog API.
    ...
    /**
    * Get blogs from a given Zapier portal, as identified by its API key
    *
    ...
    public function get_blogs($params, $content_type) {
        ...
        if ($content_type == 'json') {
            try {
                ...
                throw new Zapier_Exception('Unable to retrieve blogs: ' . $e);
            }
            ...
            throw new Zapier_Exception('Invalid content type, please choose either "json" or "atom"');
        }
    }
    ...
    *       in the Zapier portal you're creating the blog post in.
    ...
    **/
    public function create_post($blog_guid, $author_name, $author_email, $title, $summary, $post_content, $tags) {
        ...
        if ($this->isBlank($title)) {
            throw new Zapier_Exception('Blog title is required!');
        } else if ($this->isBlank($post_content)) {
            throw new Zapier_Exception('Blog content is required!');
        } else if ($this->isBlank($author_email)) {
            throw new Zapier_Exception('Author email is required!');
        }
        ...
        try {
            ...
            throw new Zapier_Exception('Unable to add blog post: ' . $e);
        }
    }
    ...
    **/
    public function update_post($post_guid, $title, $summary, $post_content, $tags, $meta_desc, $keywords) {
        ...
        if ($this->isBlank($post_guid)) {
            throw new Zapier_Exception('Post guid is required!');
        }
        ...
        $body = '<?xml version="1.0" encoding="utf-8"?>
        <entry xmlns="http://www.w3.org/2005/Atom" xmlns:hs="http://www.zapier.com/">
            <title>'. $title .'</title>
            <summary>'. $summary .'</summary>
        ...
        try {
            ...
            throw new Zapier_Exception('Unable to update blog post: ' . $e);
        }
    }
    ...
    **/
    public function publish_post($post_guid, $publish_time, $should_notify) {
        ...
        try {
            ...
            throw new Zapier_Exception('Unable to publish blog post: ' . $e);
        }
    }
