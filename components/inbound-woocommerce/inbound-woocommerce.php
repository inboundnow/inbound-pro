	...
	*/
	public static function license_setup() {
		...
		if ( class_exists( 'INBOUNDNOW_EXTEND' ) ) {
			$license = new INBOUNDNOW_EXTEND( INBOUNDNOW_WOOCOMMERCE_FILE , INBOUNDNOW_WOOCOMMERCE_LABEL , INBOUNDNOW_WOOCOMMERCE_SLUG , INBOUNDNOW_WOOCOMMERCE_CURRENT_VERSION  , INBOUNDNOW_WOOCOMMERCE_REMOTE_ITEM_NAME ) ;
		}
	}
