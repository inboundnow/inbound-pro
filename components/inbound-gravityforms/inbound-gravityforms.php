	...
	*/
	public static function license_setup() {
		...
		if ( class_exists( 'INBOUNDNOW_EXTEND' ) ) {
			$license = new INBOUNDNOW_EXTEND( INBOUNDNOW_GRAVITYFORMS_FILE , INBOUNDNOW_GRAVITYFORMS_LABEL , INBOUNDNOW_GRAVITYFORMS_SLUG , INBOUNDNOW_GRAVITYFORMS_CURRENT_VERSION  , INBOUNDNOW_GRAVITYFORMS_REMOTE_ITEM_NAME ) ;
		}
	}
