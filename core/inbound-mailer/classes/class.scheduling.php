...
class Inbound_Mailer_Scheduling {
    ...
    public static function get_timezones() {
        return array(
            ...
            array('abbr'=>'HAEC', 'name' => __( 'Heure Avancée d\'Europe Centrale francised name for CEST' , 'inbound-email' ) , 'utc' => 'UTC+02'),
            ...
            array('abbr'=>'RET', 'name' => __( 'Réunion Time' , 'inbound-email'	) , 'utc' => 'UTC+04'),
