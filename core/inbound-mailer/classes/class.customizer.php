...
class Inbound_Mailer_Customizer {
	...
	*/
	...
	public static function launch_customizer() {
		...
		?>
		<?php
		echo '<div class="inbound-mailer-load-overlay" style="top: 0;bottom: 0; left: 0;right: 0;position: fixed;opacity: .8; display:none;"></div>';
		...
		echo '		<td>';
		echo '			<iframe id="inbound-mailer-live-preview" scrolling="yes" src="'.$preview_link.'" style="max-width: 68%; '.$correct_width.' height:1000px; left: 32%; position: fixed;  z-index: 1; border: none; overflow:hidden;
