...
function custom_add_more_lead_fields($lead_fields) {
 ...
 $new_fields =  array(
 					array(
				        'label' => __( 'Style' , INBOUNDNOW_TEXT_DOMAIN ) ,
				        'key'  => 'wpleads_style',
				        'priority' => 1,
				        'type'  => 'text'
				        ),
 					array(
				        'label' => __( 'Lead Source' , INBOUNDNOW_TEXT_DOMAIN ) ,
				        'key'  => 'wpleads_lead_source',
				        'priority' => 19,
				        'type'  => 'text'
				        ),
 					array(
				        'label' => __( 'New Field' , INBOUNDNOW_TEXT_DOMAIN ) ,
				        'key'  => 'wpleads_lead_source',
				        'priority' => 19,
				        'type'  => 'text'
				        ),
 					array(
				        'label' => __( 'Description' , INBOUNDNOW_TEXT_DOMAIN ) ,
