	...
	class acf_field_font_awesome extends acf_field
	{
		...
		*/
		...
		function input_admin_enqueue_scripts()
		{
			...
			wp_enqueue_style('acf-input-font-awesome-select2-css', INBOUNDNOW_SHARED_URLPATH . '/assets/plugins/advanced-custom-fields-dont-awesome/css/select2.css', array(), $this->settings['version']);
		}
		...
		*/
		...
		{
			// register acf scripts
			wp_enqueue_script('font-awesome-select2', INBOUNDNOW_SHARED_URLPATH . '/assets/plugins/advanced-custom-fields-dont-awesome/js/select2/select2.min.js', array(), $this->settings['version']);
