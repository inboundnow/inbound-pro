...
function wpleads_admin_enqueuescripts($hook) {
	...
	wp_enqueue_style('wpleads-global-backend-css', WPL_URLPATH.'assets/css/wpl.global-backend.css');
	...
	if ((isset($_GET['post_type'])&&$_GET['post_type']=='list')||(isset($post->post_type)&&$post->post_type=='list')) {
		wp_enqueue_style('wpleads-list-css', WPL_URLPATH.'assets/css/wpl.leads-list.css');
		wp_enqueue_script('lls-edit-list-cpt', WPL_URLPATH. 'assets/js/wpl.admin.cpt.list.js');
	}
