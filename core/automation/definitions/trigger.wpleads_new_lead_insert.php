...
class Inbound_Automation_Trigger_wpleads_new_lead_insert {
    ...
    function __construct() {
        self::$trigger = 'wpleads_new_lead_insert';
    ...
    public static function define_trigger( $triggers ) {
        ...
        $triggers[self::$trigger] = array (
            'label' => __( 'On Lead Creation' , 'inbound-pro' ),
            'description' => __( 'This trigger fires whenever a lead is updated. Does not fire on lead creation process.' , 'inbound-pro' ),
...
/* Load Trigger */
new Inbound_Automation_Trigger_wpleads_new_lead_insert;
